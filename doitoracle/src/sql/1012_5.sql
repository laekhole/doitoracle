...
select 'abcd' + empno, empno
 ...
 /* 숫자형 문자열 인 경우 +연산가능 */
select empno, ename, empno+'500' /* ''따옴표로 둘러쌓여 있는 것은 문자열. 따라서 '500'은 숫자형 문자열 */
  from emp
 where ename ='SCOTT'
 ;
 ...
 * 2000이상 3000미만 'c', 3000이상이면 's' 로 출력*/
...
select	empno,
		...
		when sal between 3000 and 4999 then 's'
		when sal >= 5000 then 'sss'
		end as sal_grade
from emp;